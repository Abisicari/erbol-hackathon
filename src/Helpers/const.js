...
export const API = "https://erbol-hackathon.herokuapp.com/products";
export const API2 = "https://erbol-hackathon.herokuapp.com/comment";
...
export const ADMIN_EMAIL = "erl@admin.com";
